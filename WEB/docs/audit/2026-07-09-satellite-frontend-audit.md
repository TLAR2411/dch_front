...
- **Synthesis merges:** 36 raw verified findings → 16 reported (same-file/same-issue merges across dimensions, e.g. four `.env.example` findings → H-1; the full mapping is recorded in the raw results JSON retained with session artifacts).
