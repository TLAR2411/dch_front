...
const onDelete = async (item) => {
  try {
    const res = await api.post("categories-delete", { id: item.id });
    if (res.data.status) {
...
const onCreate = async (data, callback) => {
  try {
    ...
    const res = await api.post("categories-store", data);
...
const onEdit = async (item) => {
  try {
    ...
    const res = await api.post("categories-show", { id: item.id });
...
const onUpdate = async (data, callback) => {
  try {
    ...
    const res = await api.post("categories-update", data);
